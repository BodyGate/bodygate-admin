...
export default function CustomerDocumentRows({ customerId, customer, pendingDocuments = {}, onPendingChange, onUploaded, compactTitle = "Documenti e certificato" }: Props) {
  ...
  return <div className="doc-panel">
    <style jsx>{`
      .doc-panel { min-width:0; overflow-x:auto; container-type:inline-size; container-name:docpanel; border:1px solid var(--border); border-radius:20px; background:var(--panel); padding:12px; color:var(--text); display:grid; gap:8px; }
