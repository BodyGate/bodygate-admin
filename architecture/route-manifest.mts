...
export const ROUTE_MANIFEST = [
  ...
  { path: "/courses/admin", id: "courses-admin", label: "Course administration", classification: "secondary", domain: "courses", audience: "administrator", risk: "high", ownership: "CRM", status: "active", visibility: "restricted", notes: "Course type, room and recurring schedule administration." },
  { path: "/courses/bookings", id: "courses-bookings", label: "Course bookings and enrollments", classification: "primary", domain: "courses", audience: "operator", risk: "high", ownership: "CRM", status: "active", visibility: "authenticated", notes: "Per-session booking and fixed-schedule enrollment management." },
  { path: "/courses/calendar", id: "courses-calendar", label: "Course calendar", classification: "primary", domain: "courses", audience: "operator", risk: "high", ownership: "CRM", status: "active", visibility: "authenticated", notes: "Weekly view of generated course sessions with cancel/complete lifecycle actions." },
  { path: "/courses/payments", id: "courses-payments", label: "Course payments", classification: "primary", domain: "finance", audience: "operator", risk: "critical", ownership: "Finance", status: "active", visibility: "authenticated", notes: "Per-session booking payments and fixed-enrollment renewal payments for courses." },
  ...
  { path: "/ui-lab/platinum/screens/[screen]", id: "ui-lab-platinum-screen", label: "Platinum screen preview", classification: "lab", domain: "design-system", audience: "developer", risk: "low", ownership: "Design System", status: "active", visibility: "restricted", notes: "Dynamic presentation-only preview governed by the Platinum screen registry." },
